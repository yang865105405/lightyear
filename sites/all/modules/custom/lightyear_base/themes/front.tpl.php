...
$(document).ready(function(e) {
  ...
  new Chart($dashChartBarsCnt, {
    ...
    // if($(".toolbar-drawer clearfix collapsed")){
    //     $(".lyear-layout-sidebar").css("margin-top","30px");
    //     $(".lyear-layout-header").css("margin-top","30px");
    // }else{
    //     $(".lyear-layout-sidebar").css("margin-top","64px");
    //     $(".lyear-layout-header").css("margin-top","64px");
    // }
