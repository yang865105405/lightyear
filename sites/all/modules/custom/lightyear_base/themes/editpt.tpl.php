<div>
    <h1>编辑页面</h1>
    <!-- <input type="text" placeholder="demo" value="<?php print $node_wrapper->nid->value();?>"> -->
</div>
			...
			<div class="content-img">
                ...
                <?php foreach($resultarr as $m) : ?>
                    <li class="content-img-list-item">
                        <img src="<?php echo $m?>" alt="">
                        <div class="hide">
                            <a index="0" class="delete-btn"><i class="gcl gcllajitong"></i></a>
                            <a index="0" class="big-btn" type="button" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="gcl gclfangda"></i></a>
                        </div>
                    </li>
                <?php endforeach;?>     
                </ul>
